...
type InteractionType = 'quiz' | 'truefalse' | 'poll';
...
export function AdminInteractionsPage() {
  ...
  const openEdit = (it: Interaction) => {
    ...
    setForm({
      ...
      options: it.type === 'truefalse' ? ['Verdadeiro', 'Falso'] : [...it.options],
  ...
  const handleSubmit = async () => {
    ...
    const payload = {
      ...
      options: opts,
      correctAnswer: form.type === 'poll' ? null : form.correctAnswer,
        ...
        <header className="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="font-body text-sm text-gray-600 mt-2">
              Crie quizzes, verdadeiro/falso e enquetes para disparar durante a aula ao vivo.
            </p>
          </div>
