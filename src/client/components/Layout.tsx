      ...
      <header className="sticky top-0 z-50 bg-white border-b-2 border-black h-20 shadow-brutal-sm">
        <div className="max-w-7xl mx-auto h-full px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          <Link to="/dashboard" className="flex items-center gap-3">
            <div className="w-10 h-10 bg-brand border-2 border-black shadow-brutal-sm flex items-center justify-center">
              <ShieldCheck size={24} className="text-white" strokeWidth={2.5} />
            </div>
            <span className="font-display font-bold text-xl uppercase tracking-tight hidden sm:block">
              CASEG<span className="text-brand">2</span>
            </span>
          </Link>
      ...
      <div className="flex">
        <aside className="hidden md:flex md:w-64 flex-col border-r-2 border-black bg-white">
          <div className="px-4 py-6">
            <Link to="/dashboard" className="flex items-center gap-3">
              <div className="w-12 h-12 bg-brand border-2 border-black shadow-brutal-sm flex items-center justify-center">
                <ShieldCheck size={24} className="text-white" strokeWidth={2.5} />
              </div>
              <div>
      ...
      >
        <div className="flex items-center justify-between px-4 py-5 border-b-2 border-black">
          <Link to="/dashboard" className="flex items-center gap-3" onClick={() => setSidebarOpen(false)}>
            <div className="w-10 h-10 bg-brand border-2 border-black flex items-center justify-center">
              <ShieldCheck size={20} className="text-white" strokeWidth={2.5} />
            </div>
            <span className="font-display font-bold uppercase tracking-tight">CASEG2</span>
          </Link>
          <button
            type="button"
